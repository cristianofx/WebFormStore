<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="WebFormsStore.Account.OpenAuthProviders" %>

<div id="socialLoginList" class="text-center">
    <h4>Logar com conta de sua rede social.</h4>
    <hr />
